      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <h2 className="text-4xl font-bold text-white">{contactData.title}</h2>
            <div className="w-12 h-12 bg-blue-500/20 rounded-full flex items-center justify-center">
              ...
              <div className="space-y-4">
                {contactData.socialLinks.map((social) => (
                  ...
                  >
                    ...
                    <div>
                      <span className="text-lg font-medium text-white group-hover:text-blue-300 transition-colors duration-300">{social.name}</span>
                      <p className="text-sm text-blue-300">{social.description}</p>
                    </div>
                  </a>
                ))}
              </div>
