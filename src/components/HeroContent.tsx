    ...
    <div className="flex-1 max-w-2xl text-center lg:text-left">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
        ...
        <button 
          ...
          className="group px-6 py-3 border-2 border-white/80 text-white text-base font-medium rounded-xl hover:bg-white hover:text-blue-900 hover:border-white transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-900 text-center inline-block shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center gap-2 justify-center backdrop-blur-sm"
        >
